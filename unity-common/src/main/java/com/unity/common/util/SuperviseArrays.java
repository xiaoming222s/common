...
public final class SuperviseArrays {
    public SuperviseArrays() {
    }
    ...
    public static <T> Integer[] ints(T[] array) {
        return transfer(array, (v) -> {
            if (v == null) {
                ...
                return v instanceof Number ? ((Number) v).intValue() : NumberUtils.toInt(SuperviseStrings.str(v), 0);
            }
        }, Integer[]::new);
    }
    ...
    public static <T> Long[] longs(T[] array) {
        return transfer(array, (v) -> {
            if (v == null) {
                ...
                return v instanceof Number ? ((Number) v).longValue() : NumberUtils.toLong(SuperviseStrings.str(v), 0L);
            }
        }, Long[]::new);
    }
    ...
    public static Long getLong(Object[] result, int i, Long l) {
        return NumberUtils.toLong(SuperviseStrings.str(get(result, i)), l);
    }

    public static String getString(Object[] result, int i) {
        return SuperviseStrings.str(get(result, i));
    }
